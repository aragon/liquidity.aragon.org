const ENV_VARS = {
  ...
  SITE_DESCRIPTION: [process.env.SITE_DESCRIPTION, 'ANT Liqudity Rewards'],
  SITE_TITLE: [process.env.SITE_DESCRIPTION, 'ANT Liquidity Rewards'],
  SITE_URL: [process.env.SITE_URL, 'https://liquidity.aragon.org/'],
}
